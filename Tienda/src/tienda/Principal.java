...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        switch(opcion){
           ...
           String[] tipoProducto = new String[numeroProductos];
           ...
           //Ingresamos un producto en cada item del arreglo 
            ...
            case 3:
                ...
                System.out.println("Nombre: "+vender.getNombre());
                System.out.println("Dirección: "+vender.getDireccion());
                System.out.println("RUC: "+vender.getRuc());
